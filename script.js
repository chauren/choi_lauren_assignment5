...
button3.addEventListener("click", writeMessage, false);
function writeMessage() {
    "use strict";
    window.alert("I have been clicked");
}
...
redirect.addEventListener("click", function (event) {
    "use strict";
    window.alert("You have clicked on the link");
...
button8.addEventListener("click", function (newWindow) {
    "use strict";
    window.open("newpage.html", "", "width=500,height=300");
});
...
button9start.addEventListener("click", function (event) {
    "use strict";
    write = window.setInterval(writeMessage, 2000);
});
button9stop.addEventListener("click", function (event) {
    "use strict";
...
button10.addEventListener("click", function (writeMessage) {
    "use strict";
